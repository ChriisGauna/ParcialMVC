...
namespace ParcialMVC.Controllers
{
    public class LibroController : Controller
    {
        ...
        {
            var libreriacontext = _context.Libro.Include(l => l.Usuario);
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Año,Genero,EsNacional,Precio,Empresa,Imagen,ClienteId")] Libro libro)
        {
            ...
            ViewData["ClienteId"] = new SelectList(_context.Set<Cliente>(), "Id", "Id", libro.ClienteId);
            return View(libro);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Año,Genero,EsNacional,Precio,Empresa,Imagen,ClienteId")] Libro libro)
        {
            if (id != libro.Id)
            {
                return NotFound();
